// app/grade-3-addition-worksheets/page.tsx
import Link from 'next/link'
import { Metadata } from 'next'

export const metadata: Metadata = {
  title: 'Third Grade Addition Worksheets Within 1,000 | 3-Digit Regrouping & More',
  description: 'Free printable 3rd grade addition worksheets within 1,000 covering three-digit regrouping, mental math strategies, and word problems.',
  alternates: {
    canonical: 'https://homeschoolmath.site/grade-3-addition-worksheets',
  },
}

export default function Grade3AdditionWorksheets() {
  const faqs = [
    {
      question: 'What addition skills should third graders have?',
      answer: 'By the end of third grade, students should be able to add fluently within 1,000 using place value understanding and the standard algorithm. This includes adding three-digit numbers with regrouping across multiple places, mentally adding 10, 100, or 1,000 to any number, and solving one- and two-step addition word problems. Most children master addition without regrouping by early 3rd grade and addition with regrouping across multiple places by the end.'
    },
    {
      question: 'What is regrouping in addition with three-digit numbers?',
      answer: 'Regrouping works the same way with three-digit numbers as with two-digit numbers, but there are more places where regrouping can happen. For 358 + 276, you add 8+6=14 (write 4, regroup 1 ten), then 5+7+1=13 (write 3, regroup 1 hundred), then 3+2+1=6 (write 6). The key is understanding place value: each time a column sums to 10 or more, you regroup to the next place value.'
    },
    {
      question: 'How can I help my child master three-digit addition with regrouping?',
    ...
    {
      question: 'What is mental math addition in third grade?',
      answer: 'Mental math means solving problems without writing steps. Third graders learn to add 10, 100, or 1,000 mentally (347+100=447, 2,568+1,000=3,568). They also learn to break numbers apart: for 345+278, think "345+200=545, +70=615, +8=623." Mental math builds number sense and flexibility.'
    },
    {
      question: 'How many addition problems should my third grader do daily?',
      answer: 'For addition practice, 15-20 focused problems per day is enough. Quality matters more than quantity. Mix practice types: some problems for algorithm practice, some for mental math, and some word problems to apply the skill.'
    },
    {
      question: 'How do I know if my child has mastered third grade addition?',
      answer: 'Mastery means your child can: 1) add three-digit numbers with regrouping accurately, 2) explain why regrouping works using place value language, 3) add 10, 100, or 1,000 mentally, 4) solve one- and two-step addition word problems, and 5) recognize when an answer is unreasonable (estimation).'
    }
  ];
        ...
        <div style={{
          ...
          <section style={{
            ...
            <h2 style={{
              ...
              Why Third Grade Addition Builds the Foundation for Advanced Math
            </h2>
            <p style={{
              color: 'var(--text-secondary)',
              lineHeight: '1.7',
            ...
            <p style={{
              ...
              Our addition worksheets build place value understanding systematically. The <Link href="/grade-3-worksheets" style={{color: 'var(--primary)', textDecoration: 'underline'}}>third grade math hub</Link> offers more resources for a complete curriculum.
            </p>
          </section>
          ...
          <section style={{marginBottom: '3rem'}}>
            <h2 style={{
              ...
              Key Addition Strategies for Third Grade
            </h2>
            <p style={{
              fontSize: '1.125rem',
              color: 'var(--text-secondary)',
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{textAlign: 'center'}}>
                  ...
                  <p style={{color: 'var(--text-secondary)'}}>Three-digit addition without regrouping. Perfect for building place value confidence.</p>
                </div>
                <div style={{textAlign: 'center'}}>
                  <div style={{
                    background: 'var(--primary)',
                  ...
                  <p style={{color: 'var(--text-secondary)'}}>Regrouping in one place (ones or tens). Introduces carrying systematically.</p>
                </div>
                <div style={{textAlign: 'center'}}>
                  <div style={{
                    background: 'var(--primary)',
                  ...
                  <p style={{color: 'var(--text-secondary)'}}>Regrouping across multiple places. For end-of-year mastery and challenge.</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section style={{marginBottom: '3rem'}}>
            ...
            <p style={{
              ...
              Everything you need to know about teaching third grade addition
            </p>
            <div style={{
              maxWidth: '800px',
              margin: '0 auto'
          ...
          <section style={{marginBottom: '3rem'}}>
            <div style={{
              ...
              <p style={{
                ...
                Generate custom addition worksheets for your third grader. Choose difficulty, problem types, and download clean PDFs with answer keys.
              </p>
              <div style={{
                display: 'flex',
                flexDirection: 'column',
