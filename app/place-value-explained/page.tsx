...
export const metadata: Metadata = {
  title: 'Place Value Explained | Visual Guide for 1st-3rd | Ones, Tens & Hundreds',
  description: 'Learn place value with a visual guide covering ones, tens, hundreds, and why digit position matters for 1st-3rd graders.',
  alternates: {
