...
const ALL_PAGES: Page[] = [
  ...
  { title: 'Notion Math Progress Dashboard', description: 'Free Notion template for homeschool math tracking — auto-calculating hours, visual mastery progress, and 30-second compliance exports.', href: '/notion-progress-dashboard', tags: ['free', 'notion', 'template', 'tracking', 'progress', 'dashboard'], category: 'resource' },
  { title: 'Year-Long Curriculum Planner Generator', description: 'Free tool that generates a complete 6 to 16 page curriculum workbook with unit tracking, assessment logs, and quarterly reflections.', href: '/year-long-curriculum-planner', tags: ['free', 'planner', 'curriculum', 'year', 'generator'], category: 'resource' },
  { title: 'Weekly Math Planner Generator', description: 'Free tool that generates unlimited weekly math planners with structured daily lesson blocks and progress tracking.', href: '/weekly-math-planner', tags: ['free', 'planner', 'weekly', 'generator', 'lesson plan'], category: 'resource' },
  // ===== COURSES =====
